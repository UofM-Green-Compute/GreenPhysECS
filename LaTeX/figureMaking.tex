...
\definecolor{definedBlue}{HTML}{56B4E9}
\definecolor{definedOrange}{HTML}{D55E00}
\begin{document}
...
\begin{figure}
\begin{center}
\pgfplotslegendfromname{namedLegendSIREnsemble}
\end{center}
\begin{subfigure}{.5\linewidth}
    \centering
    \begin{tikzpicture}
...
\begin{subfigure}{.5\linewidth}
    ...
    \begin{axis}[
        legend columns=3,
        legend entries={Susceptible,Infected,Recovered},
        legend to name=namedLegendSIREnsemble,
        enlarge x limits=false,
        xlabel = $t$ (days),
        ylabel near ticks,
       ]
...
\begin{axis}[
    ...
    legend columns=2,
    legend entries={Walker 1, Walker 2},
    width=10cm,
    height=10cm,
...
\node[yshift=-1cm, xshift = 0.5cm] at (current bounding box.north)
    {\pgfplotslegendfromname{namedLegendRandomWalk}};
\end{tikzpicture}
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}[
        ...
        \node [roundnode] (State1) {$H$};
        \node [roundnode] (State3) [below right of= State1, yshift=-1cm] {$D$};
        \node [roundnode] (State2) [above right of= State3, yshift=1cm] {$U$};
...
\begin{axis}[
    ...
    \addplot [color = black,
              ...
              error bars/.cd,
                y dir=both,
                y explicit,]
    table[x = Number of Sentinels,
          y = Change in EDP from baseline,
          y error =Standard Error,
          col sep = comma]
    {EDPchange.txt};
\end{axis}
\end{tikzpicture}
...
\begin{figure}
        ...
        \begin{tikzpicture}
         ...
         \draw [thick,red] (2,2) circle (1cm) node[above right] {$r$};
         \draw[->,thick,red](2,2) -- (2.94,2.34);
         \filldraw (2,2) circle (3pt);
         
         \filldraw (0.6, 1.06) circle(3pt);
         \filldraw (3.7, 2.9) circle(3pt);
         \filldraw (0.8, 2.2) circle(3pt);
         \filldraw (3.1, 0.5) circle(3pt);
         \filldraw [red] (1.3, 1.8) circle(3pt);
         \filldraw (2.5, 0.9) circle(3pt);
         \filldraw (3.2, 2) circle(3pt);
         \filldraw [red] (1.7, 2.6) circle(3pt);
         \filldraw (1, 3.5) circle(3pt);
         \filldraw (2.5, 3.7) circle(3pt);
         \filldraw (1.25, 0.7) circle(3pt);

         \draw (0.6, 1.06) -- (1.25, 0.7);
         \draw (0.8, 2.2) -- (1.3, 1.8);
         \draw (0.8, 2.2) -- (1.7, 2.6);
         \draw (1.3, 1.8) -- (1.7, 2.6);
         \draw (3.1, 0.5) -- (2.5, 0.9);
         \draw (2, 2) -- (1.7, 2.6);
         \draw (2, 2) -- (1.3, 1.8);
         
         
        \end{tikzpicture}
        \label{SPH Scheme Diagram}
    \caption{\normalsize{Figure depicting plants randomly plotted in a 1 x 1 area. Plants within some radius, $r$, of each other are linked on a network. Linked plants can spread the infection to one another.}}
...
\begin{figure}[ht]
    ...
    \begin{axis}[
        ...
        \addplot [color=black, mark=x, only marks] coordinates {(0,0)};
        \addplot [color=definedBlue, mark=square*, only marks] coordinates {(0,0)};
        \addplot [draw=none] coordinates {(0,0)};
        \legend{Random, Square, Future}
    \end{axis}
    \end{tikzpicture}
    ...
    \begin{axis}[
        enlarge x limits=false,
        xlabel = R/L,
        ylabel = Expected Disease Prevalence (\%)
    ]
        \addplot [color = black,
                  mark = x,
                  mark size = 3pt,
        ...
        table[x = Radius,
              y = Expected Disease Prevalence,
              y error = Standard Error,
              col sep = comma]
        {EDP(R)_Random_Out.txt};

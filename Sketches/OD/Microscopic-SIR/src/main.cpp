...
Note: 
q_nm = q_n<-m = probability to transition from state n to state m
*/ 
...
int main(int argc, char* argv[]) {
    ...
    */
    ...
    while (sampleCounter1 <= sampleNumber){
        ...
        simulate(argc, argv, beta, alpha, NO_PEOPLE, I0, Re0, timeStep, maxTime, filename); // Run Simulation
